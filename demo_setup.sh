...
echo "projects-api-role" > Project/vault-agent/role-id
vault write -f -field=secret_id auth/approle/role/projects-api-role/secret-id > Project/vault-agent/secret-id